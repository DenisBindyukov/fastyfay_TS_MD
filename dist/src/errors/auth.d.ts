...
export declare const AuthInvalidUsername: CustomErrorParams;
export declare const AuthInvalidPassword: CustomErrorParams;
export declare const SomeError: CustomErrorParams;
