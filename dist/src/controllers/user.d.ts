...
export declare const handlerAddUser: (req: AuthLoginBodyResponse) => Promise<UserSchemeWithDocument>;
...
declare const _default: {
    handlerAddUser: (req: AuthLoginBodyResponse) => Promise<UserSchemeWithDocument>;
